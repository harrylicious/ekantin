                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-yellow update-card">
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i class="feather icon-file-text text-white f-14 m-r-10"></i>Total : <?= rupiah($total_saldo_siswa); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                <h4 class="text-white"><?= number_format($total_belanja); ?></h4>
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i class="feather icon-file-text text-white f-14 m-r-10"></i>Total : <?= rupiah($total_pendapatan_belanja); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-pink update-card">
                                                    ...
                                                    <div class="card-footer">
                                                        <p class="text-white m-b-0"><i class="feather icon-file-text text-white f-14 m-r-10"></i>Total : <?= rupiah($total_pendapatan_topup); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-6">
